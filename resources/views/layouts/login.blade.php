@php
$business_name="Concord Invoices";
$icon="sa.png";
$logo="sa.png";
@endphp
...
<html lang="en">
    ...
    <head><base href="../../../"/>
		...
		<link rel="shortcut icon" href="{{asset('uploads/settings/'.$icon)}}" />
			...
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					...
					<div class="d-flex flex-center flex-lg-start flex-column">
						<!--begin::Logo-->
						<a  class="mb-7">
							<img alt="Logo" src="{{asset('uploads/settings/'.$logo)}}" width="150px" />
						</a>
						<!--end::Logo-->
						<!--begin::Title-->
						<h2 class="text-white fw-normal m-0">7.Rakeb Application</h2>
						<!--end::Title-->
					</div>
					<!--begin::Aside-->
				</div>
