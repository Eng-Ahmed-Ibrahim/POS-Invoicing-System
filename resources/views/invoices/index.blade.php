...
<button class="main-btn" data-bs-toggle="modal" data-bs-target="#add"><i class="fa-solid fa-plus mx-2"></i> Create an invoice</button>
@endsection
<div class="card">
    <div class="card-body">
        ...
        <div class="section-table">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a style="color:blue" href="{{route('invoices.show',$invoice->id)}}">#INV-{{$invoice->id}}</a></td>
                        ...
                        <td>
                            <div style="display: flex; align-items:center;justify-content: center;">
                                ...
                                <form class="mx-1" action="{{route('invoice.delete',$invoice->id)}}" method="post">
                                    @csrf

                                    <button class="btn" type="submit" onclick="return confirm('Are you sure you want to delete this invoice?');">
                                        <i class="fa-solid fa-trash" style="color: #ff0000;"></i>
                                    </button>
                                </form>
                                <a style="color:blue" href="{{route('invoices.show',$invoice->id)}}"><i class="fa-solid fa-eye"></i></a>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title fs-5" id="exampleModalLabel">Create An Invoice</h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="mb-3 col">
                            ...
                            <input required  value="1" type="number" class="form-control" name="quantity" id="Quantity" placeholder="Quantity">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col">
                            <label for="Date" class="form-label">Date</label>
                            <input required     value="{{ \Carbon\Carbon::today()->format('Y-m-d') }}"  type="date" class="form-control" name="date" id="Date" placeholder="Date">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col">
