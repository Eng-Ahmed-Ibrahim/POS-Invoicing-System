...
<div class="dropdown">
    <button class="btn btn-secondary dropdown-toggle mx-2" style="border-radius:140px;padding: 8px 10px 8px 10px;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
        Change Status
    </button>
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="{{route('invoices.updateStatus',['invoice_id' => $invoice->id, 'status' => 0])}}">Unpaid</a></li>
        <li><a class="dropdown-item" href="{{route('invoices.updateStatus',['invoice_id' => $invoice->id, 'status' => 1])}}">Partially Paid</a></li>
        <li><a class="dropdown-item" href="{{route('invoices.updateStatus',['invoice_id' => $invoice->id, 'status' => 2])}}"> Paid</a></li>
    </ul>
</div>
<button class="main-btn" data-bs-toggle="modal" data-bs-target="#add"><i class="fa-solid fa-plus mx-2"></i> Add Item</button>
@endsection
@section("content")
<div class="card">
    <div class="card-body">
        <section class="invoices">
            <div class="invoice-left">
                ...
                <div>Website: <a href="https://concordonlinestore.com/" style="color: #4e5e6a;">concordonlinestore.com</a></div>
            ...
            <div class="invoice-right">
                <div class="text-right">
                    ...
                    <div>
                        <img src="/{{$invoice->items[0]->image}}" style="height:auto;width:216px;" alt="">
                    </div>
                    @endif
                </div>
            ...
            <div class="w-100">
                ...
                <table class="w-100">
                    <thead>
                        <tr style="font-weight: bold; color: white; border-bottom: 1px solid #eee; border-top: 1px solid #eee;">
                            <th>Model number</th>
                            <th>Image</th>
                            <th>Volume</th>
                            <th>Dimensions</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset($item->image)}}" style="height:100px;" alt=""> </td>
                            <td>{{$item->volume}}</td>
            ...
            <div>
                ...
                <div style="font-size: 15px;"><b style="font-size: 15px;">Note: </b>  TVA to be paid at Sayrafa Rate</div>
                <div style="font-size: 15px;"><b style="font-size: 15px;">Full Waranty </b> For One Year</div>
                <div style="font-size: 15px;"><b style="font-size: 15px;">Delivery: </b><br>  Depends on ordered quantity and desired model within 4 days after confirmaion of order</div>
            </div>
    ...
    <div class="card-body p-3">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div>
                    <b>Status</b> : @if($invoice->status==0)Unpaid @elseif($invoice->status==1)Partially Paid @elseif($invoice->status==2) Paid @endif
                </div>
            </div>
            @if(count($invoice->items) > 0)
            <div class="col-lg-6"  style="text-align: right;">
                <a href="{{route('invoices.download_pdf',$invoice->id)}}" class="download-btn">Download Invoice</a>
            </div>
            @else 
            <div class="col-lg-6" style="text-align: right;">
                <button class="download-btn" data-bs-toggle="modal" data-bs-target="#add"><i class="fa-solid fa-plus mx-2"></i> Add an item to be able to download the invoice</button>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <div class="form-group w-100">
                                <select onchange="updatePrice()" required style="width: 100% !important;" name="product_id" class="selectpicker" data-live-search="true">
                    ...
                    <div class="row">
                        <div class="mb-3 col">
                            ...
                            <input required  type="number" class="form-control" name="quantity" id="Quantity" placeholder="Quantity">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col">
                            <label for="without_vat" class="form-label">USD Without VAT</label>
                            <input required  type="without_vat" class="form-control" name="without_vat" id="without_vat" placeholder="USD Without VAT">
                        </div>
                        <div class="mb-3 col">
                            <label for="with_vat" class="form-label">USD With VAT</label>
                            <input type="with_vat" class="form-control" name="with_vat" id="with_vat" placeholder="USD With VAT">
                        </div>
                    </div>
